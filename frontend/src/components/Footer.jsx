...
const Footer = () => {
  return (
    <div className="px-4">
      <div className="footer bg-white text-base-content mt-4 p-10">
        <aside>
         <img src="/unnamed.png" className="w-40 h-40 rounded-md" alt="" />
          <p>
            ACME Industries Ltd.
            <br />
      ...
      <div className="footer bg-white border-t-2 items-center p-4">
        <aside className="grid-flow-col items-center">
          <p>Copyright © {new Date().getFullYear()} - Punsan Sofware Engineer</p>
        </aside>
